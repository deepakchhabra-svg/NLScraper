"""
Configuration file for NLScraper
"""
import os
...
# Scraping settings
REQUEST_DELAY = 2  # Delay between requests in seconds (throttling)
...
# Selenium settings (if needed for dynamic content)
USE_SELENIUM = False  # Set to True if JavaScript rendering is required
